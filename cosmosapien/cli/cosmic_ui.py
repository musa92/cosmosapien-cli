...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    def create_clean_panel(self, content: str, title: str = "", color: str = "blue") -> Panel:
    ...
    async def clean_chat(self, provider: Optional[str] = None, model: Optional[str] = None):
        ...
        self.console.print(f"{symbol} Welcome to the cosmic chat. Using {provider} ({model}). Type 'quit' to exit.\n")
        ...
        while True:
            ...
            try:
                ...
                # Show clean response
                self.show_clean_response(response.content, response.provider, response.model)
                
            except Exception as e:
                self.console.print(f"[red]Error: {str(e)}[/red]")
                self.console.print(f"[yellow]Trying to use a different open-source model...[/yellow]")
